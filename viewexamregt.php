...
<?php
    ...
    if($numrow > 0 )
    {
       ...
       echo '</tr>';
       ?>
        <a href="tstudetails.php"><button class="btn"><b><~Back</b></button></a> <br><br>
 

         <form action="teacher_xm.php" method="POST">
                     <div class="input-box">
...
<?php
    ...
    else
    {
        ...
        echo "<script> window.location.assign('teacher_xm.php')</script>";
    }
