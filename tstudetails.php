    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <h2>student Details</h2>
               ...
               <a href="teacher_xm.php"><button class="btn"><b>View Exam Details</b></button></a><br><br>

               <form action="tstudetails.php" method="POST">
                     <div class="input-box">
...
<script>
    function myFunction() {
        window.location.assign("tstudetails.php")
}
</script>